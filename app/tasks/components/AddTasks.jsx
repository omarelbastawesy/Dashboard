  ...
  const onSubmit = async (data) => {
    ...
    try {
      const payload = {
        ...
        time: data.time,
        assignedTo: data.assignedTo || [], // Array of User IDs
        projectId: data.projectId || null, // Single Project ID or null
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <InputField
                  ...
                  register={register}
                  name="name"
                  placeholder="e.g. Sync Neural Interface"
                  required
                  validation={{
                ...
                <div className="relative group/field w-full">
                  ...
                  <div className="relative">
                    ...
                    <select
                      className="w-full pl-12 pr-6 py-3.5 rounded-2xl border border-(--border-color)/50 bg-white/5 text-(--text-primary) focus:outline-none focus:ring-2 focus:ring-(--color-primary)/20 focus:border-(--color-primary) transition-all duration-300 placeholder:text-(--text-muted)/40 font-bold text-sm appearance-none cursor-pointer"
                      {...register("projectId")}
                    >
                ...
                <InputField
                  ...
                  register={register}
                  name="time"
                  placeholder="e.g. 2h left, Tomorrow, 14:00"
                  required={false}
                  error={errors.time}
                />
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    {...register("description", {
                      required: "Required",
                      minLength: { value: 5, message: "At least 5 chars" },
                    })}
                  />
                </div>
                {errors.description && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-white/5">
                <RadioGroup
                  ...
                  name="status"
                  icon={faListCheck}
                  options={["To Do", "In Progress", "Done", "Review"]}
                  register={register}
                  required
                  error={errors.status}
                />
              ...
              >
                ...
                <span className="relative z-10">
                  {isSubmitting ? "Initializing..." : "Create Task Node"}
                </span>
              </button>
            </form>
          )}
